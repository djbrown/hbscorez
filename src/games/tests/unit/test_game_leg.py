...
class NormalGames(TestCase):
    ...
    def test_game_leg(self):
        ...
        first_leg_game = Game.objects.create(
            number=1,
            league=league,
        ...
        second_leg_game = Game.objects.create(
            number=2,
            league=league,
    ...
    def test_three_teams(self):
        ...
        expected = [
            (team_1, team_2, Leg.FIRST),
            (team_3, team_1, Leg.FIRST),
            (team_2, team_1, Leg.SECOND),
            (team_2, team_3, Leg.FIRST),
            (team_3, team_2, Leg.SECOND),
            (team_1, team_3, Leg.SECOND),
        ]
    ...
    def test_four_teams(self):
        ...
        expected = [
            (team_1, team_2, Leg.FIRST),
            (team_3, team_4, Leg.FIRST),
            (team_2, team_1, Leg.SECOND),
            (team_1, team_3, Leg.FIRST),
            (team_2, team_4, Leg.FIRST),
            (team_1, team_4, Leg.FIRST),
            (team_2, team_3, Leg.FIRST),
            (team_4, team_1, Leg.SECOND),
            (team_4, team_3, Leg.SECOND),
            (team_3, team_1, Leg.SECOND),
            (team_4, team_2, Leg.SECOND),
            (team_3, team_2, Leg.SECOND),
        ]
...
class TripleGames(TestCase):
    ...
    def test_three_teams(self):
        ...
        expected = [
            ...
            (team_3, team_1, Leg.FIRST),
            (team_2, team_3, Leg.FIRST),
            (team_2, team_1, Leg.BEWTEEN),
            (team_1, team_3, Leg.BEWTEEN),
            (team_3, team_2, Leg.BEWTEEN),
            (team_1, team_2, Leg.SECOND),
            (team_3, team_1, Leg.SECOND),
            (team_2, team_3, Leg.SECOND),
        ]
    ...
    def test_three_teams_single_unscheduled(self):
        ...
        expected = [
            (team_1, team_2, Leg.UNKNOWN),
            (team_3, team_1, Leg.FIRST),
            (team_2, team_3, Leg.FIRST),
            (team_2, team_1, Leg.UNKNOWN, True),
            (team_1, team_3, Leg.BEWTEEN),
            (team_3, team_2, Leg.BEWTEEN),
            (team_1, team_2, Leg.UNKNOWN),
            (team_3, team_1, Leg.SECOND),
