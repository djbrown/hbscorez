...
class CommandTest(IntegrationTestCase):
    def test_specific_association(self):
    ...
    def test_update_stored_existing_association(self):
        Association.objects.create(name="Vorarlberger HV", abbreviation="vor", bhv_id=76, source_url="http://localhost")
