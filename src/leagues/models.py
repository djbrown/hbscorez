...
class League(models.Model):
    ...
    def is_youth(abbreviation: str, name: str) -> bool:
        ...
        youth_names_indicators_two_letters = [
            gender + age_class for gender in ["m", "w"] for age_class in ["A", "B", "C", "D", "E"]
        ]
        youth_names_indicators_three_letters = [
            gender + "J" + age_class for gender in ["M", "W", "m", "w"] for age_class in ["A", "B", "C", "D", "E"]
        ]
        youth_match_strong = any(
            n in name
            for n in youth_name_indicators_direct
            + youth_names_indicators_two_letters
            + youth_names_indicators_three_letters
        )
