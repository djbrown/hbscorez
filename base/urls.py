...
urlpatterns = [
    ...
    url(r'^liga/(?P<bhv_id>\d+)/$', view_league_season_overview, name='league_overview'),
    url(r'^liga/(?P<bhv_id>\d+)/mannschaften/$', view_league_season_teams, name='league_teams'),
    url(r'^liga/(?P<bhv_id>\d+)/spiele/$', view_league_season_games, name='league_games'),
    url(r'^liga/(?P<bhv_id>\d+)/schützen/$', view_league_season_scorers, name='league_scorers'),
    url(r'^liga/(?P<bhv_id>\d+)/strafen/$', view_league_season_penalties, name='league_penalties'),
    url(r'^liga/(?P<bhv_id>\d+)/kalender/$', view_league_season_calendar, name='league_calendar'),
