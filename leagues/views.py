...
def detail(request, bhv_id):
    ...
    return render(request, 'leagues/detail.html', {
        'league': league, 'games_count': league.game_set.count(), 'teams': top_teams, 'scorers': top_league_scorers,
...
def scorers(request, bhv_id):
    ...
    return render(request, 'leagues/scorers.html', {'league': league, 'scorers': league_scorers})
...
def offenders(request, bhv_id):
    ...
    return render(request, 'leagues/offenders.html', {'league': league, 'players': penalty_scorers})
